...
export const THIS_WEEK_BY_CATEGORY: Record<string, RankItem[]> = {
  전체: [
    { title: "🌈🏃 런나잇 🌙Running💛", place: "천호동", score: 3442, emoji: "🏃", hue: 30 },
    { title: "💒라라랜드💒로 당신을초대…", place: "송파구 방이동", score: 3341, emoji: "🎬", hue: 280 },
    { title: "올림픽공원 테니스 모임", place: "송파구 오금동", score: 2282, emoji: "🎾", hue: 90 },
    { title: "💘4050별빛연가(YOU & I)", place: "천호동", score: 2268, emoji: "🌌", hue: 250 },
    { title: "🏟 잠실 야구장 직관 모임(잠야…", place: "송파구 송파동", score: 1757, emoji: "⚾", hue: 200 },
    { title: "내향인 등린이 모임", place: "송파구 가락본동", score: 1393, emoji: "🥾", hue: 150 },
    { title: "🎾러브올테니스단 (러올단 S)", place: "송파구 잠실4동", score: 1381, emoji: "🎾", hue: 110 },
    { title: "💝3040🔗인연 Love House", place: "송파구 방이동", score: 1309, emoji: "💞", hue: 330 },
    { title: "강동 보드게임 한판 🎲", place: "천호동", score: 1188, emoji: "🎲", hue: 20 },
    { title: "미사 한강 라이딩 크루 🚴", place: "하남시 미사동", score: 1042, emoji: "🚴", hue: 190 },
  ],
  운동: [
    { title: "🌈🏃 런나잇 🌙Running💛", place: "천호동", score: 3442, emoji: "🏃", hue: 30 },
    { title: "올림픽공원 테니스 모임", place: "송파구 오금동", score: 2282, emoji: "🎾", hue: 90 },
    { title: "🎾러브올테니스단 (러올단 S)", place: "송파구 잠실4동", score: 1381, emoji: "🎾", hue: 110 },
    { title: "광나루 피클볼", place: "송파구 풍납2동", score: 1120, emoji: "🏓", hue: 160 },
    { title: "강동 클라이밍 클럽 🧗", place: "성내동", score: 1002, emoji: "🧗", hue: 130 },
    { title: "🏟 잠실 야구장 직관 모임", place: "송파구 송파동", score: 880, emoji: "⚾", hue: 200 },
  ],
  자기계발: [
    { title: "미라클모닝 챌린지 ☀️", place: "천호동", score: 2140, emoji: "☀️", hue: 45 },
    { title: "<길동>놀면뭐해 스터디 모임", place: "길동", score: 1870, emoji: "🐱", hue: 30 },
    { title: "퇴근 후 영어회화 모임", place: "둔촌동", score: 1540, emoji: "🗣️", hue: 210 },
    { title: "미사 캘리그라피 클래스 ✍️", place: "미사동", score: 990, emoji: "✍️", hue: 280 },
    { title: "강동 사이드프로젝트 모임 💻", place: "천호동", score: 760, emoji: "💻", hue: 200 },
  ],
  "문화/예술": [
    { title: "💒라라랜드💒로 당신을초대…", place: "송파구 방이동", score: 3341, emoji: "🎬", hue: 280 },
    { title: "강동 보드게임 한판 🎲", place: "천호동", score: 1420, emoji: "🎲", hue: 20 },
    { title: "우쿨렐레 합주단 🎸", place: "길동", score: 1180, emoji: "🎸", hue: 300 },
    { title: "전시 같이 보러가요 🖼", place: "송파구 가락동", score: 880, emoji: "🖼️", hue: 330 },
  ],
  "아웃도어/여행": [
    { title: "남한산성 등산 모임 🥾", place: "길동", score: 2010, emoji: "🥾", hue: 130 },
    { title: "미사 한강 라이딩 크루 🚴", place: "미사동", score: 1560, emoji: "🚴", hue: 190 },
    { title: "주말 캠핑 가실 분 ⛺", place: "상일동", score: 1240, emoji: "⛺", hue: 150 },
    { title: "올림픽공원 산책 모임 🌳", place: "오금동", score: 690, emoji: "🌳", hue: 110 },
  ],
};

export const LAST_WEEK: RankItem[] = [
  { title: "💒라라랜드💒로 당신을초대…", place: "송파구 방이동", score: 4881, emoji: "🎬", hue: 280 },
  { title: "🌈🏃 런나잇 🌙Running💛", place: "천호동", score: 4429, emoji: "🏃", hue: 30 },
  { title: "올림픽공원 테니스 모임", place: "송파구 오금동", score: 3169, emoji: "🎾", hue: 90 },
  { title: "💘4050별빛연가(YOU & I)", place: "천호동", score: 3070, emoji: "🌌", hue: 250 },
  { title: "🌙동네낭만온도🌈20,30,4…", place: "상일동", score: 2940, emoji: "🌙", hue: 40 },
  { title: "동파🐋 20대 또래 모임은 처…", place: "송파구 방이동", score: 2283, emoji: "🐋", hue: 210 },
  { title: "하남.미사 3040 /좋은사람들", place: "하남시 망월동", score: 1717, emoji: "🍻", hue: 35 },
  { title: "광나루 피클볼", place: "송파구 풍납2동", score: 1688, emoji: "🏓", hue: 160 },
  { title: "브라우니 러너스", place: "천호동", score: 1684, emoji: "🍫", hue: 25 },
  { title: "강동 클라이밍 클럽 🧗", place: "성내동", score: 1502, emoji: "🧗", hue: 130 },
];
