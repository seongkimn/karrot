...
const ENDED: Challenge[] = [
  ...
  { title: "3월 매일뜨개 챌린지", status: "종료", period: "1년 동안 · 매일", people: "10명 참여" },
  { title: "[털실타래]버터케이크카디건 함뜨", status: "종료", period: "1년 동안 · 주 3일", people: "1명 참여", photo: true },
];
...
export default function ChallengeFeed({ onBack }: { onBack: () => void }) {
  return (
    <Box
      style={{
        position: "fixed",
